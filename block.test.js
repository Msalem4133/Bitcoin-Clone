...
describe('Block', () => {
  ...
  describe('mineBlock()', () => {
    ...
    it('returns the `lastHash` to be the `hash` of the lastBlock', () => {
    ...
    it('creates a SHA-256 `hash` based on proper inputes', () => {
    ...
    it('sets a `hash` that matches the difficulity criteria', () => {
